export default (function(){
  ...
  {
    let charactersBody = charactersArray.map(function(character){
      return `
        <a href="#/personagens/${character.name}/${character.id}" class="characters-row" id="${character.id}">
  ...
  function characterInfo(character)
  {
    return `
      <div class="characters-person _25">
        <img src="${character.thumbnail.path}/standard_medium.${character.thumbnail.extension}" alt="${character.name}" width="58px" height="58px" class="characters-person-img"/>
